...
```bash
git clone https://github.com/bitpay/digicore-wallet-service.git
cd digicore-wallet-service
npm install
```
To change configuration before running, see the Configuration section.
...
```
### Configuration
Configuration for all required modules can be specified in https://github.com/bitpay/digicore-wallet-service/blob/master/config.js
...
Digicore Wallet Service - bws.js
...
```javascript
  emailOpts: {
    ...
    from: 'wallet-service@digicore.io',
  }
```
